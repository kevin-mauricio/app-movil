...
public final class ListaTi extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        Tickets.setFont(new java.awt.Font("Segoe UI", 0, 10)); // NOI18N
        Tickets.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Placa", "Estado Pago", "Total Pagado", "Hr Ingreso", "Hr Salida", "T transcurrido"
            }
        ) {
        ...
        Tickets.setMaximumSize(new java.awt.Dimension(10, 0));
        ...
        if (Tickets.getColumnModel().getColumnCount() > 0) {
            ...
            Tickets.getColumnModel().getColumn(1).setPreferredWidth(25);
            ...
            Tickets.getColumnModel().getColumn(5).setResizable(false);
            Tickets.getColumnModel().getColumn(5).setPreferredWidth(25);
        }
        ...
        try {
            ...
            if (registros.size() > 0) {
                ...
                for (JsonElement registro : registros) {
                    ...
                    String Ttranscurrido = registrosOb.get("tiempo_transcurrido").getAsString();
                    ...
                    Object[] temporal = new Object[]{placaObtenida, estado, pagado, horaI, horaS,Ttranscurrido};
